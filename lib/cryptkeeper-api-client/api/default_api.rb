...
module CryptkeeperApiClient
  class DefaultApi
    ...
    def api_v1_participants_participant_id_accounts_account_id_balance_get_with_http_info(participant_id, account_id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v1/participants/{participant_id}/accounts/{account_id}/balance'.sub('{' + 'participant_id' + '}', participant_id.to_s).sub('{' + 'account_id' + '}', account_id.to_s)
    ...
    def api_v1_participants_participant_id_accounts_account_id_transactions_get_with_http_info(participant_id, account_id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v1/participants/{participant_id}/accounts/{account_id}/transactions'.sub('{' + 'participant_id' + '}', participant_id.to_s).sub('{' + 'account_id' + '}', account_id.to_s)
    ...
    def api_v1_participants_participant_id_orders_get_with_http_info(participant_id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v1/participants/{participant_id}/orders'.sub('{' + 'participant_id' + '}', participant_id.to_s)
    ...
    def api_v1_participants_participant_id_orders_id_get_with_http_info(participant_id, id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v1/participants/{participant_id}/orders/{id}'.sub('{' + 'participant_id' + '}', participant_id.to_s).sub('{' + 'id' + '}', id.to_s)
    ...
    def api_v1_tokens_token_get_with_http_info(token, opts = {})
      ...
      # resource path
      local_var_path = '/api/v1/tokens/{token}'.sub('{' + 'token' + '}', token.to_s)
    ...
    def root_get_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Empty' 
